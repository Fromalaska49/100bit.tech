			...
			<div class="row">
				<div class="col-sm-12">
					<div class="row section-container">
						<h2 class="col-sm-12">
							Retirement Ceremony Video
						</h2>
					</div>
					<div class="row youtube-embed-container">
						<div class="col-sm-12">
							<iframe class="responsive-youtube-embed" src="https://www.youtube.com/embed/9Duuf2kqkl4?rel=0" frameborder="0" style="border-width:0px;border-style:none;margin:0px;padding:0px;border-radius:inherit;" allowfullscreen></iframe>
						</div>
					</div>
					<div class="row section-container">
						<div class="col-sm-12">
							On Friday, January 13, 2017, Lt Col Paul Greenlee celebrated his retirement from the Air Force, with family and friends, after 24 years of dedication and service to the nation.
						</div>
					</div>
					<!--
